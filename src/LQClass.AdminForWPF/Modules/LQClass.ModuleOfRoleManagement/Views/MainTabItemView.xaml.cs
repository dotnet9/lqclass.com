...
namespace LQClass.ModuleOfRoleManagement.Views
{
	...
	public partial class MainTabItemView : UserControl, ICloseable
	{
		...
		{
			InitializeComponent();
			this.Closer = new CloseableHeader(ModuleOfRoleManagementModule.KEY_OF_CURRENT_MODULE, I18nManager.Instance.Get(I18nResources.Language.MainTabItemView_Header).ToString(), true);
		}
