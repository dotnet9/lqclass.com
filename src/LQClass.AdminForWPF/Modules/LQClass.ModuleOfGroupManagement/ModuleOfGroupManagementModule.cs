...
namespace LQClass.ModuleOfGroupManagement
{
	...
	{
		public const string KEY_OF_CURRENT_MODULE = "MenuKey_GroupManagement";
		private readonly IRegionManager _regionManager;
		private readonly IUnityContainer _unityContainer;

		public ModuleOfGroupManagementModule(IRegionManager regionManager, IUnityContainer unityContainer)
		{
			I18nManager.Instance.Add(LQClass.ModuleOfGroupManagement.I18nResources.UiResource.ResourceManager);
