...
public partial class I18nStringExtension : MultiBindingExtensionBase
{
    ...
    private class MultiValueConverter : IMultiValueConverter
    {
        ...
        public MultiValueConverter(I18nStringExtension owner)
        {
            _owner = owner;
        }
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            throw new ArgumentException(
                $"The {nameof(I18nStringExtension)} does not support {keyValue?.GetType()} type, " +
...
public class ArgCollection : Collection<object>
{
    ...
    public ArgCollection(I18nStringExtension owner)
    {
        _owner = owner;
    }
